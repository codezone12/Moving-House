    ...
    return (
        <div>
            ...
            <div class="h-fit bg-[#d1dce7] ">
                <h3 className="text-5xl font-medium pt-28"><span className="animate-pulse duration-200 text-gray-500">How </span>does it <span className="text-orange-600">work</span></h3>
