      ...
      >
        <div className="text-center">
            ...
            <div className="flex my-auro">
              ...
              >
                <p className="text-left">
                  I will leave the keys at the Hemfrid office 12 pm the work day
          ...
          <p className="text-4 text-left italic my-2">
            ...
            you will find the address and opening hours of your nearest Hemfrid
            office where you can hand over the key.
          </p>
          <div
            className="mt-10"
