  ...
  return (
    <div className="bg-cover" style={{ backgroundImage: "url('https://images.ctfassets.net/37vwfxlcawdb/1TfE1UU6y8uJw1qSaSGma6/2ff488f042edf4fe6a7ce60a33c3abca/Startsida.jpg?q=50&fm=avif&w=1200')" }}>
      ...
      <div className="text-start mr-auto pt-40 md:px-28 px-10 text-white text-5xl font-medium font-['Young Serif'] ">
        ...
        {!hideInitialForm && <>  <div className="flex w-1/2 md:w-2/5 hover:shadow-lg hover:shadow-black text-lg font-bold hover:border-none hover:text-green-500 transform hover:scale-90 transition-transform delay-200">
          <input
          ...
          <div onClick={handleRef} className="flex-1 flex items-center justify-between bg-white focus:border-none focus:outline-none text-black text-lg p-3 rounded-r-lg mt-10 placeholder-black font-bold cursor-pointer bg-opacity-80 transform transition-transform delay-200 hover:placeholder-gray-500">
            {show && city && (
              <>
                <p className='text-left'>{city} </p>
                <p>
                  <svg height="24" width="24" viewBox="0 0 24 24" class="fcNb" style={{ fill: 'green' }}>
                    <g>
          ...
          <div className="flex justify-center items-center  w-1/2 md:w-2/5 bg-opacity-80 hover:shadow-lg hover:shadow-black bg-[#1e1e1e] text-lg font-bold mt-4 p-5 rounded-md hover:text-green-500 transform hover:scale-90 transition-transform delay-200">
            ...
            <button className={`text-center text-['#fff']`} onClick={handleCitySelection} disabled={isButtonDisabled} >CHOOSE SERVICES</button>
