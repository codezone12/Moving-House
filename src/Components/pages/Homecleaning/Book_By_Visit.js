      ...
      <div className="container  pt-10">
        ...
        >
          <div className="mx-auto w-2/4">
            ...
            <div className="w-15 border-2 border-gray-300 flex items-center justify-center font-bold my-4 mt-9 md-4"></div>
            ...
            <div className="mb-4 pr-10 my-auto flex">
              ...
              >
                I agree to receive custom offers from you based on the
          ...
          <div>
            ...
            >
              <div className="d-flex flex-col py-5">
                <p
                  className="text-left ml-3 mb-1 py-3"
                  style={{
                    fontSize: "22px",
                ...
                {totalPrice !== null && (
                  <>
                    ...
                    {typeof totalPrice === "number" && (
                      <p className="text-xs text-left px-5 mt-3">
                        *The price is based on the information you have
                        provided.
                      </p>
                    )}
                  </>
